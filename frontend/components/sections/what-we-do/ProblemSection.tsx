      ...
      <Container className="relative z-10">
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-slate-600 leading-relaxed text-lg">{content.description1}</p>
            <p className="mt-4 text-slate-600 leading-relaxed text-lg">{content.description2}</p>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-4 bg-white rounded-2xl shadow-xl px-5 py-4 border border-slate-100 animate-float pointer-events-none">
              <p className="text-xs text-slate-400 font-medium">{content.statLabel}</p>
              <p className="text-3xl font-black text-indigo-600 mt-0.5">{content.statValue}</p>
            </div>
          </div>
        </div>
      </Container>
