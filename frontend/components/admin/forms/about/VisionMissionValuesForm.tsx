...
export default function VisionMissionValuesForm({
  initial,
}: {
  initial: AboutVisionMissionValuesContent;
}) {
  ...
  function set<K extends keyof AboutVisionMissionValuesContent>(
    key: K,
    value: AboutVisionMissionValuesContent[K],
  ) {
