...
export default function RecognitionForm({
  ...
  initial: AboutRecognitionContent;
}) {
  ...
  function set<K extends keyof AboutRecognitionContent>(
    key: K,
    value: AboutRecognitionContent[K],
  ) {
    ...
    >
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="col-span-2">
                <ArrayField<string>
                  ...
                  createItem={() => ""}
                  renderItem={(detail, __i, onDetailChange) => (
                    <Input value={detail} onChange={onDetailChange} />
                  )}
                />
              </div>
            </div>
      ...
      <FormGroup title="Partner Strip">
        ...
        <ArrayField<string>
          ...
          createItem={() => ""}
          renderItem={(logo, _i, onChange) => (
            <Input value={logo} onChange={onChange} />
          )}
        />
      </FormGroup>
    </SectionShell>
