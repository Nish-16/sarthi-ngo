  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-3 left-3 z-50 w-10 h-10 rounded-lg bg-white border border-slate-200 shadow-sm flex items-center justify-center text-slate-700"
      ...
      {/* Mobile drawer */}
      <aside
        className={`md:hidden fixed inset-y-0 left-0 z-50 w-72 max-w-[86vw] bg-white border-r border-slate-200 flex flex-col transform transition-transform duration-200 ${
      ...
      {/* Desktop sidebar */}
      <aside className="hidden md:flex w-64 shrink-0 bg-white border-r border-slate-200 flex-col h-full">
        <SidebarBody />
      </aside>
    </>
  );
